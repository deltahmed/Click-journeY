    ...
    <body>
        ...
        <div class="search-content">
            ...
            <div id="results" class="results-container">
                <a class="result" href="#">
                    <h1>🌍 Survie sur une ile du Canada</h1>
                    <div>
                        <p>📅 12/04/2025 - 19/04/2025</p>
                        <p>👥 Voyageurs : 4-6</p>
                        <p>🏕️ Activité : Survie en pleine nature</p>
                        <p>🌡️ Climat : Forêts denses</p>
                        <p>💰 Prix : 1 200€ / personne</p>
                        <p>⭐ Note des voyageurs : 4.8/5</p>
                    </div>
